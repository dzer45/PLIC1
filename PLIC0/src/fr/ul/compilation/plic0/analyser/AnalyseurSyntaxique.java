...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed May 07 14:21:19 CEST 2014
  */
public class AnalyseurSyntaxique extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\026\000\010\004\010\007\005\015\011\001\002\000" +
    "\004\002\030\001\002\000\010\004\010\007\005\015\011" +
    "\001\002\000\022\002\uffff\004\016\005\015\006\013\011" +
    "\021\012\023\013\024\014\022\001\002\000\004\002\000" +
    "\001\002\000\010\004\010\007\005\015\011\001\002\000" +
    "\024\002\ufffb\004\ufffb\005\ufffb\006\ufffb\010\ufffb\011\ufffb" +
    "\012\ufffb\013\ufffb\014\ufffb\001\002\000\024\002\ufffc\004" +
    "\ufffc\005\ufffc\006\013\010\ufffc\011\ufffc\012\ufffc\013\ufffc" +
    "\014\ufffc\001\002\000\010\004\ufff3\007\ufff3\015\ufff3\001" +
    "\002\000\010\004\010\007\005\015\011\001\002\000\010" +
    "\004\ufff4\007\ufff4\015\ufff4\001\002\000\010\004\ufff5\007" +
    "\ufff5\015\ufff5\001\002\000\024\002\ufffe\004\016\005\015" +
    "\006\013\010\ufffe\011\ufffe\012\ufffe\013\ufffe\014\ufffe\001" +
    "\002\000\010\004\010\007\005\015\011\001\002\000\010" +
    "\004\ufff9\007\ufff9\015\ufff9\001\002\000\010\004\ufff6\007" +
    "\ufff6\015\ufff6\001\002\000\010\004\ufff8\007\ufff8\015\ufff8" +
    "\001\002\000\010\004\ufff7\007\ufff7\015\ufff7\001\002\000" +
    "\012\002\ufffa\004\016\005\015\006\013\001\002\000\012" +
    "\004\016\005\015\006\013\010\027\001\002\000\024\002" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\026\000\010\003\005\004\006\006\003\001\001\000" +
    "\002\001\001\000\004\003\025\001\001\000\006\002\013" +
    "\005\017\001\001\000\002\001\001\000\004\003\011\001" +
    "\001\000\002\001\001\000\004\002\013\001\001\000\002" +
    "\001\001\000\004\003\016\001\001\000\002\001\001\000" +
    "\002\001\001\000\004\002\013\001\001\000\004\003\024" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\002\001\001\000\004\002\013\001\001\000\004" +
    "\002\013\001\001\000\002\001\001\000\002\001\001" });
  ...
  public final java_cup.runtime.Symbol CUP$AnalyseurSyntaxique$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$AnalyseurSyntaxique$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 14: // OPER ::= MULTIPLICATION 
            {
              Expression RESULT =null;
		RESULT = new Multiplication() ; 
              CUP$AnalyseurSyntaxique$result = parser.getSymbolFactory().newSymbol("OPER",0, ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.peek()), ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.peek()), RESULT);
            }
		...
		RESULT = new Soustraction() ; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 11: // BOOL ::= DIFFERENT 
            {
              Expression RESULT =null;
		RESULT = new Inegalite(); 
              CUP$AnalyseurSyntaxique$result = parser.getSymbolFactory().newSymbol("BOOL",3, ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.peek()), ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.peek()), RESULT);
            }
          return CUP$AnalyseurSyntaxique$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 10: // BOOL ::= SUPERIEUR 
            {
              Expression RESULT =null;
		...
		RESULT = new Inferieur(); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // EXPR_BOOL ::= EXPR BOOL EXPR 
            {
              Expression RESULT =null;
		...
		Expression e2 = (Expression)((java_cup.runtime.Symbol) CUP$AnalyseurSyntaxique$stack.peek()).value;
		 	b.ajouterGauche(e1);
              ...
              CUP$AnalyseurSyntaxique$result = parser.getSymbolFactory().newSymbol("EXPR_BOOL",2, ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.elementAt(CUP$AnalyseurSyntaxique$top-2)), ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.peek()), RESULT);
            }
          return CUP$AnalyseurSyntaxique$result;
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$AnalyseurSyntaxique$stack.peek()).value;
		 RESULT = e; 
              CUP$AnalyseurSyntaxique$result = parser.getSymbolFactory().newSymbol("PROG",4, ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.peek()), ((java_cup.runtime.Symbol)CUP$AnalyseurSyntaxique$stack.peek()), RESULT);
            }
          return CUP$AnalyseurSyntaxique$result;
